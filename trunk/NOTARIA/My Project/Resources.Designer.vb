...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to DELETE FROM aplicacionrole where idaplicacion = @idApp AND idrol = @tipoRol.
        '''</summary>
        Friend ReadOnly Property deleteApplicationRolebyIdApp() As String
            Get
                Return ResourceManager.GetString("deleteApplicationRolebyIdApp", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to SELECT distinct (a.idaplicacion) FROM aplicacion a, rol r, aplicacionrole ar where ar.idrol = @tipoRol and ar.idaplicacion = a.idaplicacion.
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to SELECT app.modulo FROM aplicacionrole a, aplicacion app WHERE a.idaplicacion = app.idaplicacion AND a.idrol = @tipoRol.
        '''</summary>
        Friend ReadOnly Property selectModuleByIdRol() As String
            Get
                Return ResourceManager.GetString("selectModuleByIdRol", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to SELECT * FROM usuario u WHERE u.nombre = @name and password = @pass.
        '''</summary>
        Friend ReadOnly Property selectUserByNamePass() As String
            Get
                Return ResourceManager.GetString("selectUserByNamePass", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to UPDATE aplicacionrole SET idaplicacion = @idApp WHERE idrol = @tipoRol.
        '''</summary>
        Friend ReadOnly Property updateApplicationRole() As String
            Get
                Return ResourceManager.GetString("updateApplicationRole", resourceCulture)
            End Get
        End Property
